...
export default function RegisterView() {
    ...
    //el use mutate se usa cuando se quiere hacer una petición POST, PUT o DELETE en uan vista
    ...
    return (
        <>
            ...
            <p className="text-2xl font-light text-white mt-5">
                ...
                <span className="text-gradient font-bold text-transparent"> crear tu cuenta</span>
            </p>
