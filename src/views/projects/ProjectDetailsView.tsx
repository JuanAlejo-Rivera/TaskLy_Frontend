...
export default function ProjectDetailsView() {
    ...
    //este codigo sirve para obtener la data del proyecto por su id
    const { data, isLoading, isError } = useQuery({
        queryKey: ['project', projectId],//debe ser unico, no se puede repetir en otras paginas y el projecId se usa para identificar el proyecto
